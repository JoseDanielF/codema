...
?>">
	<header class="header container-header full-width<?php echo $stickyHeader ? ' ' . $stickyHeader : ''; ?>">
		...
		<?php if ($this->countModules('menu', true)) : ?>
			<div class="w-100 bg-cinza navbar navbar-expand-lg navbar-dark nav-secondary-color">
				<div class="grid-child container-nav">
                  ...
                  <?php \Joomla\CMS\HTML\HTMLHelper::_('bootstrap.collapse', '.navbar-toggler', ['toggle' => false]); ?>
				</div>
			</div>
		<?php endif; ?>
	</header>
